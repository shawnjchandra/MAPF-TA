...
{ 
    ...
    {
        //Cek assigment agen ke task, apakah lokasinya sudah sama kayak tujuan selanjutnya dari task
        if (current_assignment[k] != -1 && states[k].location == ongoing_tasks[current_assignment[k]]->get_next_loc())
        {
            //Kalau sampai, update target selanjutnya, dan cek apakah udah selesai atau belum
